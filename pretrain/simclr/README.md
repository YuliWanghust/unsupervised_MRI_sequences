...
$ python -m pretrain.simclr.train -c dermamnist -epochs 2000 -aug natural -bsize 64
# Perform further pretraining on a pretrained model
$ python -m pretrain.simclr.train -c dermamnist -epochs 2000 -aug natural -fin pretrain-dermamnist -bsize 64
```
