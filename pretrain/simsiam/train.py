...
from pretrain.simsiam.contrastive_downloader import ContrastiveDownloader
from pretrain.simsiam.simsiam import SimSiamLM
from pretrain.simsiam.utils import (
...
def train_simsiam(
    ...
    **kwargs,
    ...
    if os.path.isfile(destination_path):
        ...
        model = SimSiamLM.load_from_checkpoint(destination_path)
    ...
    if pretrained_path:
        ...
        model = SimSiamLM(max_epochs=max_epochs, **kwargs)
    ...
    model = SimSiamLM.load_from_checkpoint(
