...
from pretrain.simsiam.custom_augs import RandomAdjustSharpness, RandomEqualize
...
class AugmentationSequenceType(Enum):
    ...
    Diskeep:
        random horizontal flip > random vertical flip > Elastic Transform > GuassianBlur 
    """
    NATURAL = "natural"
    SIMPLE = "simple"
    NOVEL = "novel"
...
augmentation_sequence_map = {
    ...
    AugmentationSequenceType.NOVEL_GREYSCALE.value: transforms.Compose([
        ...
        AugmentationSequenceType.Dis_keep.value: transforms.Compose([
        # Normalise to 3 channels
        transforms.Lambda(convert_to_rgb),
        # Transformation 1: random horizontal flip
        transforms.RandomHorizontalFlip(),
        #Transformation 2: random vertical flip
        transforms.RandomVerticalFlip(),
        # Transformation 3: resize to 14
        #transforms.Resize(size=14),
        #Trasformation 4: Elastic transofrmation
        transforms.ElasticTransform(160.0),
        # Transformation 5: Gaussian blur
        ...
        AugmentationSequenceType.Dis_keep_crop.value: transforms.Compose([
        # Normalise to 3 channels
        transforms.Lambda(convert_to_rgb),
        # Transformation 1: random horizontal flip
        transforms.RandomHorizontalFlip(),
        ...
        #transforms.Resize(size=14),
        #Trasformation 4: Elastic transofrmation
        transforms.ElasticTransform(50.0),
        # Transformation 5: Gaussian blur
        transforms.GaussianBlur(kernel_size=3),
